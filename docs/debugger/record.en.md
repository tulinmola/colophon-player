...
Every standard frame's worth of ticks, the record keeps a whole machine: the processor mid-instruction, every part wired to it, and the whole of RAM. It keeps 128 of them, a little over two and a half seconds, at 132,776 bytes each. Alongside them it keeps the last 524,288 stores the processor made, each with the address the byte landed at and the instruction that sent it. The module asks the page for 32MB when it loads and never grows, and this record is three quarters of it.
