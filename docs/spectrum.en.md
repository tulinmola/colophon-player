...
| `tape`     | —            | A `.tap`, `.tzx` or `.cdt` to put in the deck, fetched relative to the page. It goes in stopped: [pressing PLAY](debugger/tape.en.md#who-turns-the-reel) is the reader's.                                                              |
